...
struct ReceivedBusinessCard {
    ...
    init(id: BusinessCardID, originalID: BusinessCardID, ownerID: UserID, receivingDate: Date, languageVersions: [BusinessCardLocalization], tagIDs: [BusinessCardTagID] = [], notes: String = "") {
        self.id = id
